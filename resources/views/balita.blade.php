...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <button class="btn btn-primary btn-round ml-auto tambah-balita" data-toggle="modal" data-target="#addRowModal">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" min="0" class="form-control" id="nikbalita" name="nik_balita" placeholder="Masukkan NIK Balita">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="balita">Nama Balita</label>
                                                        <input type="text" class="form-control" id="balita" name="nama_balita" placeholder="Masukkan Nama Balita">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="tgllahir">Tanggal Lahir</label>
                                                        <input type="date" name="tanggal_lahir" class="form-control" id="tgllahir" placeholder="Masukkan Tangga Lahir Balita">
                                                    </div>
                                                    <div class="form-check">
                                                        <label>Jenis Kelamin</label><br/>
                                                        <label class="form-radio-label">
                                                            <input class="form-radio-input" type="radio" name="jenis_kelamin" value="Laki-Laki">
                                                    ...
                                                    <div class="form-group", style="margin-top: -20px;">
                                                        <input type="hidden" name="id_dusun" class="form-control" id="idDusunOrtu">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="dusun">Nama Dusun</label>
                                                        <input type="text" class="form-control" id="namaDusunOrtu" placeholder="Nama Dusun"  disabled>
                                                    </div>
                                                </div>
                                            </div>
                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                <button type="button" class="btn btn-link btn-primary edit-balita" data-toggle="modal" data-target="#updateRowModal" data-id="{{ $dt->id }}"
                                                data-nkb="{{ $dt->nik_balita }}"
                                                ...
                                                <button type="button" data-id="{{ $dt->id }}" class="btn btn-link btn-danger hapus-balita">
                                                    <span class="btn-label">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('balita.edit') }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group" style="margin-top: -20px;">
                                                <input type="hidden" min="0" class="form-control" id="id_balita" name="id_balita" placeholder="Masukkan NIK Balita">
                                            </div>
                                            <div class="form-group">
                                                <label for="nikbalita">NIK Balita</label>
                                                <input type="number" min="0" class="form-control" id="nik_balita" name="nik_balita" placeholder="Masukkan NIK Balita">
                                            </div>
                                            <div class="form-group">
                                                <label for="balita">Nama Balita</label>
                                                <input type="text" class="form-control" name="nama_balita" id="nama_balita" placeholder="Masukkan Nama Balita">
                                            </div>
                                            <div class="form-group">
                                                <label for="tgllahir">Tanggal Lahir</label>
                                                <input type="date" name="tanggal_lahir" class="form-control" id="tanggal_lahir" placeholder="Masukkan Tangga Lahir Balita">
                                            </div>
                                            <div class="form-check">
                                                <label>Jenis Kelamin</label><br/>
                                                <label class="form-radio-label">
                                                    <input class="form-radio-input" type="radio" name="jenis_kelamin" id="jenis_kelamin"  value="Laki-Laki">
                                                    <span class="form-radio-sign">Laki-Laki</span>
                                                </label>
                                                <label class="form-radio-label ml-3">
                                                    <input class="form-radio-input" type="radio" name="jenis_kelamin" id="jenis_kelamin" value="Perempuan">
                                                    <span class="form-radio-sign">Perempuan</span>
                                                </label>
                                            </div>
                                            <div class="form-group" style="margin-top: -20px;">
                                                <input type="hidden" class="form-control" name="id_orangtua" id="id_orangtua">
                                            </div>
                                            <div class="form-group">
                                                <label for="orangtua">Nama Orang Tua</label>
                                                <input type="text" class="form-control" name="nama_orangtua" id="nama_orangtua" disabled>
                                            </div>
                                            <div class="form-group", style="margin-top: -20px;">
                                                <input type="hidden" name="id_dusun" class="form-control" id="idDusunOrtu">
                                            </div>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success:(response) => {
                    ...
                    $.each(response.data,(index,ortu) => {
                        selectOrtu.append($('<option>').text(index + 1 + '.' + ' ' + ortu.nama_bapak + '/' + ortu.nama_ibu).attr('value', ortu.id));
                    })
                },
       ...
       $('.edit-balita').click(function() {
            ...
            $("#updateRowModal #jenis_kelamin").filter('[value="' + jenisKelamin + '"]').prop('checked', true);
